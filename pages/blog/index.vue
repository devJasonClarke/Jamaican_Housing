  ...
  <div>
    ...
    <SectionPadding>
      ...
      <v-row class="flex-wrap-reverse">
        <v-col cols="12" md="8">  <ul>
          <li v-for="article of articles" :key="article.slug" class="blog-link">
            <NuxtLink
              :to="{ name: 'blog-slug', params: { slug: article.slug } }"
              :class="[theme ? 'white--text' : 'black--text', 'd-flex flex-wrap flex-sm-nowrap']"
            >
              <img
     :src="require('~/assets/images/house.jpg')" 
        ...
        <v-col cols="12" md="4">asdfsadfsd</v-col>
      </v-row>
      </v-container>
    </SectionPadding>
  </div>
