  ...
  <div>
    ...
    <SectionPadding>
      <SectionTitlesSecondary
        :mainTitle="parish"
        paragraph="St. James is one of the fastest-growing parishes on the island with large credits due to Montego Bay, the second city. Known for its famous hotels, internationally renowned beaches and friendly residents, St. James generates one-third of the island's tourism revenue."
      />
    </SectionPadding>
...
import img from "~/assets/images/parishes/st-james.jpg";
export default {
  fetch() {
    // console.log("fetch");
  ...
  computed: {
    ...
    ...mapGetters({
      properties: "getProperties/stJames/properties",
      lastVisible: "getProperties/stJames/lastVisible",
      paginateNext: "getProperties/stJames/paginateNext",

      properties: "getProperties/stJames/properties",

      loading: "getProperties/stJames/loading",
  ...
  methods: {
    ...mapActions({
      ...
      getParishProperties: "getProperties/stJames/getParishProperties",

      setLoading: "getProperties/stJames/setLoading"
    }),
