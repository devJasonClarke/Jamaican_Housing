            ...
            <v-row class="mb-3">
              <v-col cols="12" sm="6"
                ...
                <a
                  ...
                  :href="
                    `https://twitter.com/share?url=${process.env.BASE_URL}property/${this.$route.params.slug}&text=Have a look at this property from Real Estate Ja:`
                  "
                >
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    `https://www.facebook.com/sharer.php?=${process.env.BASE_URL}property/${this.$route.params.slug}`
                  "
                >
                  <v-btn class="d-inline" small icon fab color="white">
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    `mailto:?subject=Have a look at this property from Real Estate Ja&amp;body=The property: ${process.env.BASE_URL}property/${this.$route.params.slug}.`
                  "
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    `https://wa.me/?text=Have a look at this property from Real Estate Ja: ${process.env.BASE_URL}property/${this.$route.params.slug}`
                  "
                >
                  <v-btn class="d-inline" small icon fab color="white">
    ...
    sendMessage() {
      ...
      this.$fire.firestore
        ...
        .add({
          ...
          property: `${process.env.BASE_URL}property/${this.theParam}`,
          read: false
        })
        .then(docRef => {
