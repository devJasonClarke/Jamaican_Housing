            ...
            <v-row class="mb-3">
              <v-col cols="12" sm="6"
                ...
                <a
                  ...
                  :href="
                    `https://twitter.com/share?url=${process.env.BASE_URL}property&text=Have a look at this property:`
                  "
                >
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    `https://www.facebook.com/sharer.php?=${process.env.BASE_URL}property`
                  "
                >
                  <v-btn class="d-inline" small icon fab color="white">
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    ` https://t.me/share/url?url=${process.env.BASE_URL}property&text=Have a look at this property:`
                  "
                >
                  <v-btn class="d-inline" small icon fab color="white">
                ...
                <a
                  ...
                  rel="nofollow noopener"
                  :href="
                    `https://wa.me/?text=Look at this offer ${process.env.BASE_URL}property`
                  "
                >
                  <v-btn class="d-inline" small icon fab color="white">
