  ...
  <div>
    ...
    <SectionPadding>
      <SectionTitlesSecondary
        ...
        paragraph="Last updated July 07, 2021"
      />
    </SectionPadding>
    ...
    <SectionPadding class="backgroundShade">
      ...
      <v-container>
        ...
        <p class="body-2">
          We offer an unlimited free trial to new users who register with the
          Site. The account will not be charged until upgraded to a paid
          version.
        </p>
      </v-container>
      <v-container>
      ...
      <v-container>
        ...
        <ul class="body-2">
          ...
          <li>
            4. Trick, defraud, or mislead us and other users, especially in any
          ...
          <li>
            6. Engage in any automated use of the system, such as using scripts
          ...
          <li>
            10. Decipher, decompile, disassemble, or reverse engineer any of the
            software comprising or in any way making up a part of the Site.
          </li>
          <li>
            11. Attempt to bypass any measures of the Site designed to prevent
          ...
          <li>
            13. Copy or adapt the Site’s software, including but not limited to
          ...
          <li>
            16. Upload or transmit (or attempt to upload or to transmit) any
          ...
          <li>
            17. Disparage, tarnish, or otherwise harm, in our opinion, us and/or
            the Site.
          </li>
          <li>
            18. Use the Site in a manner inconsistent with any applicable laws
            or regulations.
          </li>
        </ul>
      </v-container>
      ...
      <v-container>
        ...
        <p class="body-2">
          ...
          Montego Bay, Jamaica. The language to be used in the arbitral
          proceedings shall be English. The governing law of the contract shall
          be the substantive law of Jamaica.
        </p>
      ...
      <v-container>
        <p class="text-h6">LIMITATIONS OF LIABILITY</p>
        <p class="body-2">
      ...
      <v-container>
        <p class="text-h6">INDEMNIFICATION</p>
        <p class="body-2">
